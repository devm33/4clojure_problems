...
(defn __
  ...
  ([f m n]
   (letfn [(row [r c] (lazy-seq (cons (f r c) (row r (inc c)))))]
     (lazy-seq
       (cons (row m n) (__ f (inc m) n))))))


(assert (= (take 5 (map #(take 6 %) (__ str)))
           [["00" "01" "02" "03" "04" "05"]
            ["10" "11" "12" "13" "14" "15"]
            ["20" "21" "22" "23" "24" "25"]
            ["30" "31" "32" "33" "34" "35"]
...
(assert (= (take 6 (map #(take 5 %) (__ str 3 2)))
           [["32" "33" "34" "35" "36"]
            ["42" "43" "44" "45" "46"]
            ["52" "53" "54" "55" "56"]
            ["62" "63" "64" "65" "66"]
...
(assert (= (class (__ (juxt bit-or bit-xor)))
           (class (__ (juxt quot mod) 13 21))
           (class (lazy-seq))))

(assert (= (class (nth (__ (constantly 10946)) 34))
